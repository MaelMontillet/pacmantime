...
function can() {
	...
	function map(canvas){
		obst(0,0,37,1,canvas);
		obst(39,0,8,1,canvas);
		obst(0,0,1,26,canvas);
		obst(0,28,1,7,canvas);
		obst(47,0,1,9,canvas);
		obst(47,11,1,25,canvas);
		obst(0,35,8,1,canvas);
		obst(11,35,37,1,canvas);
		obst(1,3,4,1,canvas);
	...
	function draw(x,y,canvas){
		...
		obst(x,y,2,2,canvas);
		window.requestAnimationFrame(function() { draw(x,y,canvas) });
